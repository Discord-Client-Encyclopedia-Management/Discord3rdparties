...
| Tools          | Badge                              | Markdown                             |
| :------------- | :--------------------------------- | :----------------------------------- |
| Vibe coded     | ![Vibe coded][Vibe coded-Badge]    | `![Vibe coded][Vibe coded-Badge]`    |
| AI assets used | ![AI assets used][AI assets-Badge] | `![AI assets used][AI assets-Badge]` |
