...
| [GoonCord](https://github.com/OTKUSteyler/GoonCord) |GoonCord is based on [gonnercord](https://github.com/OTKUSteyler/goonercord) also focus to keep the legacy of cumcord going. but is based on [ShiggyCord](https://github.com/kmmiio99o/ShiggyCord). | [![TypeScript][TypeScript-Badge]][TypeScript-Url] | 🟢 Active |
...
| [Rain](https://codeberg.org/raincord/rain) | A Discord mod for mobile written from the ground up by the creators of [Kettu](https://github.com/C0C0B01/Kettu) | [![TypeScript][TypeScript-Badge]][TypeScript-Url] | 🔵 *(still in development state)* |
