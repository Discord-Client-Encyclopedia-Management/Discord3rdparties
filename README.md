...
| [Dissent](https://github.com/diamondburned/dissent) | Dissent (previously gtkcord4) is a third-party Discord client designed for a smooth, native experience on Linux desktops. | [![Go][Go-Badge]][Go-Url] | [![Swift][Swift-Badge]][Swift-Url] <br/> ⛔ Does not mimic a real client[^7] |
