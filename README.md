...
| [Vendetta](https://github.com/vendetta-mod/Vendetta) | A Discord Mod that is compatible with Android and iOS! | [![TypeScript][TypeScript-Badge]][TypeScript-Url] |  ⛔ Pushed malicious code to "test stuff" endangering users to the wrath of discords possibility of banning. DO not use anything by this dev. |
...
| [Velocity](https://github.com/Velocity-Discord/Velocity) | Velocity is a Discord Client modification that allows you to extend discord's functionality and capabilities. | [![JavaScript][JavaScript-Badge]][JavaScript-Url] | 🔵 Active *(Variable[^2]\)* |
