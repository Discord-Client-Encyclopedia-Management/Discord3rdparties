...
| [GoonCord](https://github.com/kmmiio99o/ShiggyCord) |GoonCord is based on [gonnercord](https://github.com/OTKUSteyler/goonercord) also focus to keep the legacy of cumcord going. but is based on [Shiggy](https://github.com/kmmiio99o/ShiggyCord). | [![TypeScript][TypeScript-Badge]][TypeScript-Url] | 🟢 Active |
