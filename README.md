...
| [Spacebar Chat](https://spacebar.chat/) | Open source, themeable and extendable discord-compatible native Spacebar client | [![TypeScript][TypeScript-Badge]][TypeScript-Url] | 🟠 On hiatus, since Dec 2024 *(Variable[^5]\)* <br/> ⛔ Does not support discord.com instead is a spacebar client |
