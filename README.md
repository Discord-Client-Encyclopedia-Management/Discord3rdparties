...
| [Spacebar Chat Client](https://github.com/spacebarchat/client) | Open source, themeable and extendable discord-compatible native Spacebar client | [![TypeScript][TypeScript-Badge]][TypeScript-Url] | 🟠🟢 Development blocked *(Variable[^5]\)* <br/> ⛔ Does not support discord.com instead is a spacebar client |
...
| :---: | :---: | :---: | :---: | :---: |
| [Polyphony](https://github.com/polyphony-chat) | Almost fully featured re-implementation of Discord API Server, support for federation planned using Polyproto as the server-server API | [![Rust][Rust-Badge]][Rust-Url] | 🟢 Yes | 🟢 Active |
