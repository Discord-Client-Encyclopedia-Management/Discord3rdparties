...
| [Rain](https://github.com/ra1ncord/rain) | A Discord mod for Android written from the ground up | [![TypeScript][TypeScript-Badge]][TypeScript-Url] | 🔵 *(still in development state)* |
...
| [BTLoader](https://github.com/CloudySn0w/BTLoader) | Provides builds of [Kettu](https://github.com/C0C0B01/Kettu) for iOS. But will utilise [Rain](https://github.com/ra1ncord/rain) once Rain is fully released.| [![TypeScript][TypeScript-Badge]][TypeScript-Url] | 🟢 Active |
