...
| [VendroidEnhanced](https://github.com/VendroidEnhanced/Vendroid) | Vendroid is a custom client for Discord that loads the mobile website and injects Vencord, the cutest client mod. *Fork of [Vendroid](https://github.com/Vencord/Android)*. | [![Java][Java-Badge]][Java-Url] [![JavaScript][JavaScript-Badge]][JavaScript-Url] | 🟢 Active |
