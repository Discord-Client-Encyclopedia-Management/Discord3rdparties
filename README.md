...
| [Ra1n](https://github.com/ra1ncord/ra1n) | A Discord mod for Android written from the ground up | [![TypeScript][TypeScript-Badge]][TypeScript-Url] | 🔵 *(still in development state)* |
...
| [Oldcord](https://github.com/oldcordapp/OldCordV3) | An open-source reimplementation of the old (2015-2018) Discord backend, including an on-demand client patcher. | [![JavaScript][JavaScript-Badge]][JavaScript-Url] | 🟢 Yes | 🟠 Active development, official instance is down |
