...
| [Spacebar Chat](https://spacebar.chat/) | Open source, themeable and extendable discord-compatible native Spacebar client | [![TypeScript][TypeScript-Badge]][TypeScript-Url] | 🟢🟠 Inactive *(Development blocked[^5]\)* <br/> ⛔ Does not support discord.com instead is a spacebar client |
