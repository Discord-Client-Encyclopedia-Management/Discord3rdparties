...
| [Aethercord](https://discord.com/invite/7DPNymYGmq) | Aethercord is a Discord client that was created for utilizing disallowed modifications of Discord's voice engine to boost audio quality, increase volume limits or analyze audio packets (pcm/packet). | [Closed source] | 🟢 Active |
