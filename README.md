...
| [JankClient](https://github.com/MathMan05/JankClient) |  A SpaceBar Client written in TS HTML and CSS | [![TypeScript][TypeScript-Badge]][TypeScript-Url] | 🟠🟢 Active, incomplete <br/> ⛔ May get you banned if used on discord.com |
...
**Important**: **DO NOT** publish guides on how to point Discord's official clients to third party server implementations. Spacebar previously got in trouble due to this. Guides on using third party clients with third party servers have not experienced this problem.
