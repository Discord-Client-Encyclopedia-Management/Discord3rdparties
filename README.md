...
| :---: | :---: | :---: | :---: |
| [Aliucord](https://github.com/Aliucord/Aliucord) | A modification for the Discord Android App | [![Java][Java-Badge]][Java-Url] [![Kotlin][Kotlin-Badge]][Kotlin-Url] [![Dart][Dart-Badge]][Dart-Url] | 🟢 Active |
...
| [WebCord](https://github.com/SpacingBat3/WebCord) | A Discord and Fosscord API-less client made with Electron | [![TypeScript][TypeScript-Badge]][TypeScript-Url] | 🟠 On hiatus, since September 2022 |
